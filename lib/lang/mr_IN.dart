const Map<String, String> mrIN = {
  ...
  'Please login to continue': 'कृपया सुरू ठेवण्यासाठी लॉग इन करा',
  'Sign in with Google': 'गूगल सह साइन इन करा',
  'email/phone': 'ईमेल किंवा फोन नंबर',
  'password': 'पासवर्ड',
  'login': 'लॉगिन',
  'or': 'किंवा',
  'sign in guest': 'अतिथी म्हणून साइन इन करा',
  'Dont have an account yet?': 'अजून खाते नाही?',
  'signup': 'साइनअप',
  'here': 'येथे',
//signup page
...
//tips
  'visible':
      'तुमचे डिव्हाइस एका पानावर धरून ठेवा जेणेकरून ते तुमच्या स्मार्टफोनच्या स्क्रीनवर स्पष्टपणे दिसेल.',
  'blur': 'प्रतिमा अस्पष्ट नसावी आणि चांगल्या प्रकाशात क्लिक केली पाहिजे.',
  'single': 'एकच पानाची प्रतिमा देण्याचा प्रयत्न करा',

//feedback
  'Feedback': 'अभिप्राय',
  'Leave a feedback': 'प्रतिक्रिया द्या',
  'Share your feedback': 'तुमचा अभिप्राय शेअर करा',
  'SUBMIT': 'प्रस्तुत करा',
  'Ask Me Later': 'मला नंतर विचार',
};
